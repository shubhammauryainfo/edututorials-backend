...
<head>
  ...
  <title>Educate Tutorials | Subscribe</title>
  <!-- Favicon -->
...
<div class="page-flex">
  ...
  <div class="container main-nav">
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
        <h2 class="main-title">Subscribe Responses</h2>
        <?php
...
<tr>
<td>{$rows['Email']}</td>
<td class='pt-3'> <a href='./del/del_sub.php?no={$rows['id']}'><button type='button' class='btn btn-primary'>Delete</button></a></td>
</tr>

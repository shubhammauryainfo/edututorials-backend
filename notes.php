...
<head>
  ...
  <title>Educate Tutorials | Notes</title>
  <!-- Favicon -->
...
<div class="page-flex">
  ...
  <div class="container main-nav">
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
       ...
       include "connect.php";
       $query = "SELECT * FROM `notes` ORDER BY `No` DESC;" ;
  ...
  while ($rows = mysqli_fetch_array($result)) {
    ...
    <td class='pt-3'> <a href='./del/del_notes.php?no={$rows['no']}' target='_blank'><button type='button' class='btn btn-primary'>Delete</button></a></td>
    </tr>

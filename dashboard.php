...
<head>
  ...
  <title>Educate Tutorials | Dashboard</title>
  <!-- Favicon -->
...
<div class="page-flex">
  ...
  <div class="container main-nav">
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
        <h2 class="main-title">Form Responsess</h2>
        <?php
  ...
  while ($rows = mysqli_fetch_array($result)) {
    ...
    <td>{$rows['Email']}</td>
     <td>{$rows['subject']}</td>
      <td>{$rows['message']}</td>
       <td> <a class='btn btn-danger mx-1' href='./del/del_form.php?no={$rows['No']}' role='button'>delete</a></td>
    </tr>
